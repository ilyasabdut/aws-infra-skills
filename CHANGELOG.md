...
### Changed
- **diagnostic-workflows**: Enhanced ImagePullBackOff diagnosis with ECR image verification steps
- **diagnostic-workflows**: Added ECR image verification steps to ECS diagnosis workflow
...
### Fixed
- **safety-hook**: Block additional mutation verbs (148 patterns total):
  - `claim-` (GameLift game server claim)
  - `hibernate-` (EC2 instance hibernation)
  - `reopen-` (Support case reopening)
  - `verify-` (SES email identity verification)

## [1.23.23] - 2026-09-23

### Fixed
- **safety-hook**: Block additional mutation verbs (144 patterns total):
  - `activate-`, `deactivate-` (WorkDocs/Cloud9 user activation)
  - `batch-stop-` (Glue batch-stop-job-run)
  - `record-` (SWF activity heartbeat)
  - `respond-` (SWF activity task completion)
  - `sync-` (RoboMaker deployment sync)

## [1.23.22] - 2026-09-23

### Fixed
- **safety-hook**: Block additional mutation verbs (138 patterns total):
  - `archive-` (Detective finding archival)
  - `checkin-`, `checkout-` (License Manager license operations)
  - `configure-` (MediaTailor channel configuration)
  - `launch-` (Evidently experiment launch)
  - `upgrade-` (CloudDirectory schema upgrade)

## [1.23.21] - 2026-09-23

### Fixed
- **safety-hook**: Block additional mutation verbs (132 patterns total):
  - `transfer-` (MediaLive input device transfer)
  - `expire-` (AppStream session expiration)
  - `index-` (Rekognition index-faces writes face data to collection)

## [1.23.20] - 2026-09-23

### Fixed
- **safety-hook**: Block additional mutation verbs (129 patterns total):
  - `notify-` (Proton deployment status notification)
  - `connect-` (Elastic Inference instance connection)
...
### Fixed
- **safety-hook**: Block additional mutation verbs (118 patterns total):
  - `upload-` (S3 multipart upload)
  - `deprecate-` (IoT thing type deprecation)
  - `undeprecate-` (IoT undeprecation)
  - `dispose-` (CodeArtifact package disposal)
  - `deliver-` (Config snapshot delivery)
  - `reserve-` (Ground Station contact reservation)
...
[1.23.27]: https://github.com/ilyasabdut/aws-infra-skills/compare/v1.23.26...v1.23.27
...
[1.23.21]: https://github.com/ilyasabdut/aws-infra-skills/compare/v1.23.20...v1.23.21
[1.23.20]: https://github.com/ilyasabdut/aws-infra-skills/compare/v1.23.19...v1.23.20
