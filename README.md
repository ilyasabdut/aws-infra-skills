...
| **aws-investigation** | AWS CLI patterns for EKS, EC2, ECR, CloudWatch, S3, RDS, Lambda, SQS, SNS, Route53, Secrets Manager, SSM, ECS, DynamoDB, API Gateway, ElastiCache, Step Functions, EventBridge, CloudFront, WAF, Kinesis, CodeBuild, CodePipeline, Auto Scaling, ACM, Cognito, OpenSearch, Redshift, Athena, CloudTrail, EFS, Service Quotas, Cost Explorer, Glue, EMR, Backup, Security Hub, GuardDuty, Inspector, Config, X-Ray |
...
- `aws *` with 153 mutation verb patterns:
