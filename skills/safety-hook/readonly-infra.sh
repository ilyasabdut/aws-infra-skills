...
if [[ "$CMD" =~ (^|[[:space:]])aws[[:space:]]+([a-z0-9-]+) ]]; then
    ...
    #   Batch mutations: batch-write-, batch-delete-, batch-put-, batch-associate-, batch-disassociate-, batch-update-, batch-import-
    #   Replacement: replace-
    ...
    #     admin-delete-, admin-disable-, admin-enable-, admin-reset-, admin-set-,
    #     admin-update-, admin-create-, admin-confirm-, admin-forget-, admin-initiate-,
    #     admin-respond-, admin-link-, admin-add-, admin-remove-
    #   Device: forget-
    #   Session: global-
    ...
    #   Subscribe: subscribe, unsubscribe (bare verbs, no trailing dash)
    #   Vote: vote-
    #   Other: add-, write-
    if [[ "$CMD" =~ [[:space:]](delete-|terminate-|modify-|update-|create-|put-|remove-|deregister-|attach-|detach-|enable-|disable-|start-|stop-|reboot-|add-|register-|associate-|disassociate-|authorize-|revoke-|import-|copy-|send-|invoke|publish|subscribe|unsubscribe|run-|send-command|tag-resource|untag-resource|allocate-|release-|accept-|reject-|cancel-|write-|execute-|set-|reset-|restore-|failover-|promote-|revert-|move-|batch-write-|batch-delete-|batch-put-|batch-associate-|batch-disassociate-|batch-update-|batch-import-|batch-stop-|replace-|request-|purchase-|assign-|unassign-|submit-|apply-|bundle-|confirm-|switchover-|migrate-|export-|clone-|lock-|unlock-|provision-|deprovision-|advertise-|withdraw-|rotate-|renew-|scale-|suspend-|resume-|complete-|abort-|continue-|change-|monitor-|unmonitor-|purge-|rebuild-|merge-|swap-|compose-|retry-|trigger-|invalidate-|override-|post-|resend-|split-|flush-|forget-|global-|pause-|signal-|admin-delete-|admin-disable-|admin-enable-|admin-reset-|admin-set-|admin-update-|admin-create-|admin-confirm-|admin-forget-|admin-initiate-|admin-respond-|admin-link-|admin-add-|admin-remove-|upload-|deprecate-|undeprecate-|dispose-|deliver-|reserve-|decline-|deploy-|grant-|group-|ungroup-|issue-|peer-|unpeer-|resolve-|notify-|connect-|transfer-|expire-|index-|archive-|checkin-|checkout-|configure-|launch-|upgrade-|activate-|deactivate-|record-|respond-|sync-|claim-|hibernate-|reopen-|verify-|acknowledge-|initialize-|vote-) ]]; then
